...
DomDistiller's source, 1.0.1 tag, standalone parser and frozen oracle are unchanged.
The coordinated suite instead shares Readability parsing through Trafilatura;
its timings must not be pooled with the historical standalone results below.
